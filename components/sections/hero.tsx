...
export function Hero() {
  ...
  return (
    <section className="min-h-screen flex flex-col justify-center pt-20 relative overflow-hidden">
      <div className="hidden md:block absolute -right-32 md:-right-48 top-32 md:top-40 w-[400px] h-[400px] lg:w-[650px] lg:h-[650px] pointer-events-none animate-orb-rotate -z-10 scale-125">
        <Image src="/images/quaternity-opening-setup.png" alt="" width={650} height={650} className="w-full h-full" priority />
      </div>
